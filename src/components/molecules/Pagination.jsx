...
const Pagination = (props) => {
  ...
  return (
    <ReactPaginate
      ...
      activeClassName={`flex items-center justify-center px-3 h-8 text-gray-200 border border-teal-200 bg-slate-400 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white`}
      //   forcePage={page - 1}
    />
  );
};
